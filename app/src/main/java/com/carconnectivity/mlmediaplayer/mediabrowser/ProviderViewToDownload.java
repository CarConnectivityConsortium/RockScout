 ...
 */
public class ProviderViewToDownload implements ProviderView {
    ...
    public ProviderViewToDownload(String label, String id, Drawable iconDrawable) {
    ...
    public ProviderViewToDownload(String label, String id, URL iconURL) {
        this.label = UiUtilities.trimLabelText(label);
        this.id = id;
