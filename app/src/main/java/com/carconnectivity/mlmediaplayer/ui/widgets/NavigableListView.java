...
public class NavigableListView extends ListView {
    ...
    public NavigableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public NavigableListView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public NavigableListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
